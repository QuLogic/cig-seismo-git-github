...
\begin{frame}
 ...
 \begin{tikzpicture}[
  ...
  \draw<1-2>[path] (9.east) to[out=0,in=180] (E root.west);
  ...
  \draw<3>[path, dashed] (9.east) to[out=0,in=180] (E root.west);
  ...
  \draw<4->[path] (10.east) to[out=0,in=180] (E root.west);
 \end{tikzpicture}
\end{frame}
...
\begin{frame}
 ...
 \begin{tikzpicture}[
  ...
  \draw<1>[path] (7.east) to[out=0,in=180] (P root.west);
  \draw<2>[path, dashed] (7.east) to[out=0,in=180] (P root.west);
  \draw<2>[path] (10.east) to[out=0,in=180] (P root.west);
  \draw<2>[label] (10.east) to[out=0,in=180] (P root.west);
  \draw<3>[path] (10.east) to[out=0,in=180] (P root.west);
 \end{tikzpicture}
\end{frame}
...
\begin{frame}
 ...
 \begin{columns}
  ...
  \begin{column}{0.6\textwidth}
   \begin{tikzpicture}[%
    ...
    \draw<1-2>[->] (E 9.east) to[out=0,in=180] (E root.west);
    \draw<3>[->, dashed] (E 9.east) to[out=0,in=180] (E root.west);
 ...
 \begin{tikzpicture}[
  ...
  \draw<3>[label, decoration={raise=-0.75em,
                              text={|\scriptsize| git commit -a}}]
   (E 10.east) to[out=0,in=180] (M root.west);
  \draw<4->[->] (E 10.east) to[out=0,in=180] (E root.west);
  ...
  \begin{column}{0.6\textwidth}
   ...
   \begin{tikzpicture}[%
    ...
    \node[anchor=south, shift={(1.5em,1em)}] at (P repository.east)
     {Piero's Computer};
    \draw<1-2>[->] (P 7.east) to[out=0,in=180] (P root.west);
    \draw<3>[->, dashed] (P 7.east) to[out=0,in=180] (P root.west);
    \draw<3,4>[->] (P 10.east) to[out=0,in=180] (P root.west);
   \end{tikzpicture}
  \end{column}
 \end{columns}
